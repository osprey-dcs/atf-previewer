...
#ifndef __LineSeriesBuilderMinMax_h
#define __LineSeriesBuilderMinMax_h 1
...
class LineSeriesBuilderMinMax : public LineSeriesBuilderBase {
...
public:
  ...
  explicit LineSeriesBuilderMinMax ();
  ~LineSeriesBuilderMinMax ();
