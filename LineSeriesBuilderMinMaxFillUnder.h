...
#ifndef __LineSeriesBuilderMinMaxFillUnder_h
#define __LineSeriesBuilderMinMaxFillUnder_h 1
...
class LineSeriesBuilderMinMaxFillUnder : public LineSeriesBuilderBase {
...
public:
  ...
  explicit LineSeriesBuilderMinMaxFillUnder ();
  ~LineSeriesBuilderMinMaxFillUnder ();
  ...
  bool init;
  bool noPrev;
  double yfirst, ylast, ymin, ymax, prevXWithPixRes;
