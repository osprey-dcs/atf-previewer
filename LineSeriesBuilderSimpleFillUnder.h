...
#ifndef __LineSeriesBuilderSimpleFillUnder_h
#define __LineSeriesBuilderSimpleFillUnder_h 1
...
class LineSeriesBuilderSimpleFillUnder : public LineSeriesBuilderBase {
...
public:
  ...
  explicit LineSeriesBuilderSimpleFillUnder ();
  ~LineSeriesBuilderSimpleFillUnder ();
